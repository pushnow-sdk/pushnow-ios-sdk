...
//  PushNowDemo (UIKit)
//
//  A complete PushNow integration in one file. Mirrors the Pushy-style
...
final class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(
        ...
        // Initialize PushNow SDK. The backend identifies your app by
        ...
        pushnow.onNotificationReceived { [weak self] msg, ack in
        ...
        pushnow.onNotificationOpened { [weak self] msg in
            // Show an alert dialog
            let alert = UIAlertController(
